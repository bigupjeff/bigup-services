...
$markup = <<<END
<!-- wp:query {"queryId":4,"query":{"postType":"service","order":"asc","sortByOrder":true,"perPage":"3","inherit":false},"namespace":"service-query-loop","className":"queryLoopCards-coloured","layout":{"type":"constrained"}} -->
...
return array(
	'title'       => __( 'Service Cards First 3', 'bigup-services' ),
	'description' => _x( 'Display first 3 services as cards', 'Block pattern description', 'bigup-services' ),
